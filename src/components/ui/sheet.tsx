...
function SheetOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/60 duration-200",
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col bg-secondary shadow-xl ring-1 ring-foreground/10",
          "duration-300",
          "data-[state=open]:animate-in data-[state=open]:fade-in-0",
          "data-[state=closed]:animate-out data-[state=closed]:fade-out-0",
          sideClasses[side],
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-3 border-t border-border-detail/40 px-6 py-4",
        className,
      )}
      {...props}
    />
...
function SheetTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-4xl font-bold leading-tight text-primary",
        className,
      )}
      {...props}
    />
